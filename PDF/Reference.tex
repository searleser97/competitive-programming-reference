...
\addcontentsline{toc}{subsubsection}{Max Flow Min Cost}
\begin{minted}{cpp}
...
\addcontentsline{toc}{subsubsection}{Prime Factorization (Sieve)}
\begin{minted}{cpp}
...
\addcontentsline{toc}{subsubsection}{Prime Factorization (Sieve) 2}
\begin{minted}{cpp}
#include "Primes Sieve.cpp"
